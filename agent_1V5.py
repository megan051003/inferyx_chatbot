...
4. For **read**, user should only give the datapod name. Ask if missing.
...
def extract_fields_conversational(user_input: str) -> Optional[str]:
    ...
    if user_values["action"] == "create" and user_values["name"] and user_values["pk"]:
        ...
        try:
            ...
            #print(f"📦 Datapod '{user_values['name']}' created successfully.")
    ...
    # ✅ Delete Datapod
        ...
        try:
            ...
            datapod.delete()
           # print(f"🧹 Datapod '{user_values['name']}' deleted successfully.")
        except Exception as e:
